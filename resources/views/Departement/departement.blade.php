                                ...
                                <table class="table table-bordered table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="{{ route('departement.edit', $dp->id) }}" class="btn btn-success btn-sm" data-toggle="tooltip" title="Edit"><i class="fa fa-pen"></i></a>
                                                    <form action="{{ route('departement.destroy', $dp->id) }}" method="POST" style="display:inline;">
                                                        @csrf
                                                        @method('DELETE')
