...
class PaymentController extends Controller
{
    public function index(Request $request)
    {
        ...
        $paymentsWithoutUserId = Payment::whereNull('user_id')->count();
        $paymentPendingCount = Payment::where('status', 'pending')->count();
        $paymentSuccessCount = Payment::where('status', 'success')->count();
        ...
        return view('Payment/payment', compact('payment', 'paymentcount', 'provinces', 'cities', 'paymentsWithoutUserId', 'paymentPendingCount', 'paymentSuccessCount'));
    }
    ...
    public function pending(Request $request)
    {
        // Eager load 'user', 'profile', 'province', dan 'city'
        $query = Payment::with(['user.profile.province', 'user.profile.city'])
            ->where('status', 'pending'); // Menambahkan filter status
        ...
        return view('Payment/paymentpending', compact('payment', 'paymentcount', 'provinces', 'cities'));
    }
}
